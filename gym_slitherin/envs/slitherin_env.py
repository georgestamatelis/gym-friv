...
class Chopper(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        img_name="/home/georgestamatelis/gym-slitherin/gym_slitherin/envs/chopper.png"
        ...
        if image is not None:
            bg = image / 255
        self.icon = cv2.imread(img_name,cv2.IMREAD_GRAYSCALE) / 255.0
        self.icon_w = 64
        self.icon_h = 64
...
class SlitherinEnv(Env):
    metadata = {
        'render.modes': ['human', 'rgb_array'],
        'video.frames_per_second': 10
    }
    def __init__(self):
        super(SlitherinEnv, self).__init__()
        

        
        # Define a 2-D observation space
        self.observation_shape = (600, 600)
