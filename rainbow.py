...
Original file is located at
    https://colab.research.google.com/github/Curt-Park/rainbow-is-all-you-need/blob/master/08.rainbow.ipynb
...
class Network(nn.Module):
    def __init__(
        ...
        print("out_dim=",out_dim,"in_dim=",in_dim)
...
# environment
env_id = "gym_slitherin:zombieOnslaught-v1"
env = gym.make(env_id)
IN_COLAB=False
if IN_COLAB:
