...
ASSETS
"""
assetsPath="/home/georgestamatelis/gym-friv/Game/"
...
STATE_H = 100
class agentPlatformerEnv2(gym.Env, EzPickle):
    metadata = {
    ...
    def reset(self):
        ...
        self.blocks.append(Block(400,300,100,50))

        

        self.goalBlock=Block(425,275,25,25,color=(255,255,255))
        self.movingDownwards=True

        self.spikes.append(Spikes(75,650,75,50))
        self.spikes.append(Spikes(100,650,50,50))
        self.spikes.append(Spikes(150,650,50,50))
        self.spikes.append(Spikes(200,650,50,50))
        self.spikes.append(Spikes(250,650,50,50))
        self.spikes.append(Spikes(300,650,50,50))
        self.spikes.append(Spikes(350,650,50,50))
        self.spikes.append(Spikes(400,650,50,50))
        self.spikes.append(Spikes(450,650,50,50))
        self.spikes.append(Spikes(500,650,50,50))
        self.spikes.append(Spikes(550,650,50,50))
        self.spikes.append(Spikes(600,650,50,50))
        self.spikes.append(Spikes(650,650,50,50))   
        self.spikes.append(Spikes(700,650,50,50))
        self.spikes.append(Spikes(750,650,50,50))
        self.spikes.append(Spikes(770,650,50,50))
