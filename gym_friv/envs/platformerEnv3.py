...
STATE_H = 100
class agentPlatformerEnv3(gym.Env, EzPickle):
    metadata = {
    ...
    def __init__(self, verbose=1):
        ...
        #try black and white space to save memory
        #self.observation_space = spaces.Box(
    ...
    def reset(self):
        ...
        self.blocks.append(Block(725,100,100,50))
    ...
    def step(self, action):
        ...
        if (action==4 or action==7 or action==8) and self.man.y >=10 and self.man.fuelLeft>0:
            ...
            if manCollides==False:
                self.man.y=self.man.y-self.man.vel*2 -10 # 10 is to undo gravity    
                inVacum=False
